...
![Alipay interface for Taobao payment showing credit card option.]({{ site.baseurl }}/images/Alternatives-to-PayPal-for-Shopping-on-Taobao.webp)
...
![Taobao agent website where users can buy products on behalf of customers using PayPal.]({{ site.baseurl }}/images/Using-Taobao-Agent.webp)
