...
toc_sticky: true 
toc_icon: "list-ul"
tags: [estimate shipping costs without losing money]
featured: false
...
Even if you're not a huge enterprise, showing consistent growth can open doors for better pricing. Regularly reviewing your shipping volume and comparing it to carrier thresholds for discounts can be very beneficial. For more insights on this, you can check out guides like [How to Negotiate Shipping Rates](https://www.easypost.com/blog/how-to-negotiate-shipping-rates) (placeholder for external link).
