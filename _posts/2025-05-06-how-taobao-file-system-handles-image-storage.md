...
![Flat namespace model of Taobao File System managing billions of small image files.]({{ site.baseurl }}/assets/images/Flat-File-Structure.webp){: .img-responsive loading="lazy"}
...
![ Image processing and delivery pipeline supported by Taobao File System.]({{ site.baseurl }}/assets/images/Performance-and-Throughput.webp){: .img-responsive loading="lazy"}
