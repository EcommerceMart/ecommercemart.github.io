...
toc_sticky: true 
toc_icon: "list-ul"
tags: [shopify theme detector free vs manual]
featured: false
...
1.  Open your web browser and go to one of the detector tool websites (e.g., [WhatStore.com](https://www.whatstore.com/)).
...
Yes, Shopify has its own official [Shopify Theme Store](https://themes.shopify.com/) where you can browse and purchase thousands of themes, both free and paid. This is a great place to start if you're looking for inspiration and want to see what's available directly from Shopify and third-party developers. While they don't list what themes *other stores* use, it's a comprehensive catalog for your own store.
