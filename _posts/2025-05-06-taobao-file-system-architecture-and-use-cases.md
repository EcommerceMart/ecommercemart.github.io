...
![Diagram illustrating the role of metadata servers in managing file indexing and namespace in the Taobao File System.]({{ site.baseurl }}/images/TFS-Architecture-Overview.webp)
...
![Illustration of TFS managing large volumes of small files in an e-commerce platform like Taobao.]({{ site.baseurl }}/images/Handling-Billions-of-Small-Files.webp)
