...
![Use a Directory Structure for Languages]({{ site.baseurl }}/assets/images/Use-Directory-Structure-for-Languages.webp){: .img-responsive loading="lazy"}
...
![Automate Synchronization]({{ site.baseurl }}/assets/images/Automate-Synchronization.webp){: .img-responsive loading="lazy"}
