...
![Model wearing Carhartt WIP hooded jacket and cargo pants in an urban streetwear setting, showcasing modern style and durability]({{ site.baseurl }}/assets/images/Carhartt-WIP-The-Fashion-Side.webp){: .img-responsive loading="lazy"}
...
![ Person wearing classic Carhartt Detroit jacket working outdoors, demonstrating durable and reliable workwear]({{ site.baseurl }}/assets/images/Carhartt-Most-Popular-Products.webp){: .img-responsive loading="lazy"}
