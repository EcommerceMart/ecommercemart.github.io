...
| Name                 | Layout | Example |
| -------------------- | ------ | ------ |
| [Posts Archive](https://ecommercemart.github.io/year-archive/) | `layout: singles` | [year-archive.md](https://github.com/mmistakes/blob/master/docs/_pages/year-archive.md) |
| [Categories Archive](https://ecommercemart.github.io/categories/) | `layout: categories` | [category-archive.md](https://github.com/mmistakes/blob/master/docs/_pages/category-archive.md) |
| [Category Archive](https://ecommercemart.github.io/categories/edge-case/) | `layout: category` | [edge-case.md](https://github.com/mmistakes/blob/master/docs/_pages/edge-case.md) |
| [Tags Archive](https://ecommercemart.github.io/tags/) | `layout: tags` | [tag-archive.md](https://github.com/mmistakes/blob/master/docs/_pages/tag-archive.md) |
| [Tag Archive](https://ecommercemart.github.io/tags/markup/) | `layout: tag` | [markup.md](https://github.com/mmistakes/blob/master/docs/_pages/markup.md) |
| [Collection Archive](https://ecommercemart.github.io/recipes/) | `layout: collection` | [recipes-archive.md](https://github.com/mmistakes/blob/master/docs/_pages/recipes-archive.md) |
...
A page with a search form. Add `layout: search` to the YAML Front Matter similar to [this example](https://github.com/mmistakes/blob/master/test/_pages/search.md) on the test site.
...
If you'd like to add, remove, or change the order of these default links you can do so by editing [`_includes/social-share.html`](https://github.com/mmistakes/blob/master/_includes/social-share.html).
...
Under the `$buttoncolors:` color map in `_sass/_buttons.scss` simply add a name (this will be appended to `btn--`) that matches the new button class. In our case `reddit` ~> `.btn--reddit`.
