...
1. Fork the [Minimal Mistakes repo](http://github.com/mmistakes/fork).
...
1. [Download Minimal Mistakes](https://github.com/mmistakes/releases/tag/2.2.1) and unzip.
